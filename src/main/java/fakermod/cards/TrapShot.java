...
import fakermod.actions.TrapShotAction;
...
public class TrapShot extends AbstractEasyCard {
    public final static String ID = makeID("TrapShot");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new TrapShotAction(magicNumber, m));
    }
