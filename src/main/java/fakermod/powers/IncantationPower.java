...
public class IncantationPower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = ModFile.makeID("IncantationPower");
    ...
    public void updateDescription() {
        ...
        if (AbstractDungeon.player != null
            ...
            this.description=  DESCRIPTIONS[0] + amount + "/6";

        } else {
            this.description = (this.amount < 6 ? DESCRIPTIONS[0] : DESCRIPTIONS[1]) + amount + "/6";
        }
    }
