...
public class UBWBPower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = ModFile.makeID("UBWBPower");
    ...
    public UBWBPower(final AbstractCreature owner) {
        name = NAME;
        ID = POWER_ID;
