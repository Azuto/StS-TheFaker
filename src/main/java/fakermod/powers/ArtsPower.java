...
public class ArtsPower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = ModFile.makeID("ArtsPower");
    ...
    public ArtsPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
        type = PowerType.BUFF;
    ...
    public AbstractPower makeCopy() {
        return new ArtsPower(owner, source, amount);
    }
