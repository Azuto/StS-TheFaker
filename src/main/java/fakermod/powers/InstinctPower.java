...
public class InstinctPower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = ModFile.makeID("InstinctPower");
    ...
    public InstinctPower(final AbstractCreature owner, final AbstractCreature source, final int amount, int nextDamage) {
        name = NAME;
        ID = POWER_ID;
        type = PowerType.BUFF;
        isTurnBased = true;
    ...
    public AbstractPower makeCopy() {
        return new InstinctPower(owner, source, amount, nextDamage);
    }
}