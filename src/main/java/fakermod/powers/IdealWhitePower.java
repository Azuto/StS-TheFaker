...
public class IdealWhitePower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = ModFile.makeID("IdealWhitePower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

    public IdealWhitePower(final AbstractCreature owner, final int amount) {
        ID = POWER_ID;
        name = NAME;
        type = PowerType.BUFF;
    ...
    public AbstractPower makeCopy() {
        return new IdealWhitePower(owner, amount);
    }
