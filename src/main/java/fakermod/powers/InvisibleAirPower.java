...
public class InvisibleAirPower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = ModFile.makeID("InvisibleAirPower");
    ...
    public InvisibleAirPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
        type = PowerType.BUFF;
        isTurnBased = true;
    ...
    public AbstractPower makeCopy() {
        return new InvisibleAirPower(owner, source, amount);
    }
}